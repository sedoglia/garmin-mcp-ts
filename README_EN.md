...
The published bundle is built by the `Release` workflow, which runs on a tag
(`git tag v4.3.1 && git push origin v4.3.1`) and attaches `.mcpb` and `.sha256` to a draft
